...
export const routes: Routes = [
  // Landing domain
  {
    path: '',
    loadChildren: () =>
      import('./domains/landing/routes').then(m => m.landingRoutes),
  },
  ...
  // Auth domain (login + register at top-level paths)
  {
    path: '',
    loadChildren: () =>
      import('./domains/auth/routes').then(m => m.authRoutes),
  },
  ...
  // Admin shell — protected, composes all admin domain routes
  {
    ...
    loadChildren: () =>
      import('./layout/admin-shell/admin.routes').then(m => m.adminRoutes),
  },
  ...
  // Portal domain (customer self-service)
  {
    path: 'portal',
    loadChildren: () =>
      import('./domains/portal/routes').then(m => m.portalRoutes),
  },
  ...
  // Hotspot domain (public captive-portal flow)
  {
    path: 'hotspot',
    loadChildren: () =>
      import('./domains/hotspot/routes').then(m => m.hotspotPublicRoutes),
  },
