...
@Component({
  selector: 'SignUpSimpleCard',
  imports: [MatCard, MatButton, MatFormField, MatInput, MatLabel, NgOptimizedImage, MatCheckbox, RouterLink],
  template: `
