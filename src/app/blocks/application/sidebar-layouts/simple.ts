...
@Component({
  selector: 'SidebarLayoutSimple',
  imports: [MatIcon, MatIconButton, MatSidenav, MatSidenavContainer, MatSidenavContent, MatListItem, MatNavList, MatListItemIcon, MatListSubheaderCssMatStyler, MatListItemMeta],
  template: `
...
export class SidebarLayoutSimple {
  // Dependencies
