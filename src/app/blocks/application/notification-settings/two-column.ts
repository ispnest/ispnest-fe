...
@Component({
  selector: 'NotificationSettingsTwoColumn',
  imports: [MatDivider, MatButton, MatCheckbox],
  template: `
    <form class="flex flex-col gap-y-12 sm:gap-y-16">
      ...
      <div class="grid gap-8 md:grid-cols-3">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-6 md:col-span-2">
          <!-- Section -->
          <div class="flex flex-col sm:col-span-full">
            ...
            <div class="mt-6 flex flex-col gap-y-6">
              <mat-checkbox class="[&_.mdc-checkbox]:mt-0.5 [&>.mdc-form-field]:items-start" checked>
              ...
              <mat-checkbox class="[&_.mdc-checkbox]:mt-0.5 [&>.mdc-form-field]:items-start">
...
export class NotificationSettingsTwoColumn {}
