...
@Component({
  selector: 'AlertDialogsWideActions',
      ...
      <div buiDialog disableClose role="alertdialog" [autoFocus]="undefined" [open]="dialogOpen()">
        ...
        <ng-template buiDialogPortal>
          ...
          <div buiDialogContent>
            <div buiDialogHeader>
              <h2 buiDialogTitle>Payment successful!</h2>
              <p buiDialogDescription>Your payment has been processed successfully. You will receive a confirmation email shortly with your receipt and order details.</p>
            </div>
            <div buiDialogFooter>
              <button buiDialogClose matButton class="flex-1">Dismiss</button>
              <button buiDialogClose matButton class="primary flex-1">View receipt</button>
            </div>
          </div>
        </ng-template>
      </div>
...
export class AlertDialogsWideActions {
