...
@Component({
  selector: 'AlertDialogsLeftAlignedActions',
  imports: [MatButton, BuiDialog, BuiDialogTrigger, BuiDialogPortal, BuiDialogBackdrop, BuiDialogContent, BuiDialogHeader, BuiDialogTitle, BuiDialogDescription, BuiDialogFooter, BuiDialogClose],
  template: `
      ...
      <div buiDialog disableClose role="alertdialog" [autoFocus]="undefined" [open]="dialogOpen()">
        ...
        <ng-template buiDialogPortal>
          ...
          <div buiDialogContent>
            ...
            <div buiDialogFooter class="justify-start">
...
export class AlertDialogsLeftAlignedActions {
