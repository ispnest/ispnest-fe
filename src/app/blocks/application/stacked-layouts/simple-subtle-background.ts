...
@Component({
  selector: 'StackedLayoutSimpleSubtleBackground',
  imports: [MatIcon, MatIconButton, MatButton, RouterLink, RouterLinkActive, MatMenu, MatMenuTrigger, MatMenuItem],
  template: `
    <div class="flex flex-auto flex-col">
      <!-- Header -->
      <div class="flex items-center border-b bg-neutral-a2 px-6 py-4 dark:bg-neutral-a3">
...
export class StackedLayoutSimpleSubtleBackground {
  // State
  protected nav = [
    {
      id: 'dashboard',
