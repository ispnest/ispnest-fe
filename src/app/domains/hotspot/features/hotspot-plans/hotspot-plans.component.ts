            ...
            <button type="button"
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <div class="text-sm text-blue-200">{{ plan.validity }} {{ plan.validityUnit }}</div>
                  @if (plan.description) {
                ...
                <div class="text-right">
                  ...
                  @if (plan.badge) {
                    <span class="rounded-full bg-yellow-400 px-2 py-0.5 text-xs font-bold text-yellow-900">
                      {{ plan.badge }}
                    </span>
                  }
                </div>
