...
import {
  InvoiceDto, CreditLedgerEntryDto, CreditBalanceResponse,
  ManualCreditRequest, BillingCycleDto
...
export class InvoiceApiService {
  ...
  getByCustomer(customerId: string): Observable<InvoiceDto[]> {
    return this.http.get<InvoiceDto[]>(this.base, { params: new HttpParams().set('customerId', customerId) });
  }
